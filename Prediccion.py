...
modelo = 'D:/Universidad/Decimo_Ciclo/Proyecto2/webKirusenas/ModeloAbecedario.h5'
peso = 'D:/Universidad/Decimo_Ciclo/Proyecto2/webKirusenas/pesosAbecedario.h5'
cnn = load_model(modelo)  #Cargamos el modelo
cnn.load_weights(peso)  #Cargamos los pesos

direccion = 'D:/Universidad/Decimo_Ciclo/Proyecto2/webKirusenas/DataSetIA/Validacion'
    ...
    if resultado.multi_hand_landmarks: #Si hay algo en los resultados entramos al if
        for mano in resultado.multi_hand_landmarks:  #Buscamos la mano dentro de la lista de manos que nos da el descriptor
            ...
            if len(posiciones) != 0:
                ...
                if respuesta == 0:    # Verde
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 3)
                    cv2.putText(frame, '{}'.format(dire_img[0]), (x1, y1 - 5), 1, 1.3, (0, 255, 0), 1, cv2.LINE_AA)
                elif respuesta == 1:   # Rojo
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 3)
                    cv2.putText(frame, '{}'.format(dire_img[1]), (x1, y1 - 5), 1, 1.3, (0, 0, 255), 1, cv2.LINE_AA)
                elif respuesta == 2:  # Azul
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (255, 0, 0), 3)
                    cv2.putText(frame, '{}'.format(dire_img[2]), (x1, y1 - 5), 1, 1.3, (255, 0, 0), 1, cv2.LINE_AA)
                elif respuesta == 3:  # Blanco
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (255, 255, 255), 3)
                    cv2.putText(frame, '{}'.format(dire_img[3]), (x1, y1 - 5), 1, 1.3, (255, 255, 255), 1, cv2.LINE_AA)
                elif respuesta == 4:  # Negro
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 0), 3)
                    cv2.putText(frame, '{}'.format(dire_img[4]), (x1, y1 - 5), 1, 1.3, (0, 0, 0), 1, cv2.LINE_AA)
                elif respuesta == 5:  # Naranja
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (26, 127, 239), 3)
                    cv2.putText(frame, '{}'.format(dire_img[5]), (x1, y1 - 5), 1, 1.3, (26, 127, 239), 1, cv2.LINE_AA)
                elif respuesta == 6:  # Amarrilo
                    print(resultado)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 255), 3)
                    cv2.putText(frame, '{}'.format(dire_img[6]), (x1, y1 - 5), 1, 1.3, (0, 255, 255), 1, cv2.LINE_AA)
                else:
